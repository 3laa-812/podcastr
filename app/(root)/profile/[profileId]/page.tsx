...
const ProfilePage = ({
  ...
  return (
    <section className="mt-9 flex flex-col">
      <h1 className="text-[20px] font-bold max-md:text-center">
        Podcaster Profile
      </h1>
        ...
        <ProfileCard
          podcastData={{
            ...
            podcasts: podcastsData.podcasts.map((podcast) => ({
              ...
              // Add similar lines for any other fields as per your types
            })),
          }}
      ...
      <section className="mt-9 flex flex-col gap-5">
        <h1 className="text-[20px] font-bold">All Podcasts</h1>
